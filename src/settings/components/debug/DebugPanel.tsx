 ...
 *
 * Four tabs, each a different kind of "is this what I think it is":
 * what the controls look like, what the store holds, what the loader believes,
 * and which language is answering.
 */

type Tab = 'components' | 'state' | 'modules' | 'strings';
