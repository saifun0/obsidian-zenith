...
const EN: Dict = {
    ...
    'sync.settings.dropboxClientId.desc': 'From an app you create at dropbox.com/developers. Choose scoped access, full Dropbox or app folder, and grant files.content.read and files.content.write.',
    ...
    'sync.settings.ownApp.note': 'Your own registration, not one shipped with Zenith — a plugin cannot distribute someone else’s app identity.',
...
const RU: Dict = {
    ...
    'sync.settings.dropboxClientId.desc': 'Из приложения, созданного на dropbox.com/developers. Выберите scoped access, полный доступ или папку приложения, и включите files.content.read и files.content.write.',
    'sync.settings.onedriveClientId': 'Application (client) ID',
    ...
    'sync.settings.ownApp.note': 'Ваша собственная регистрация, а не поставляемая с Zenith — плагин не может распространять чужую идентичность приложения.',
