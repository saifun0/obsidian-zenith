...
const EN: Dict = {
    ...
    'settings.section.attention': 'Needs attention',
    ...
    'settings.mobileInsets': 'Screen edges',
    'settings.mobileInsets.desc':
        'Keeps views clear of the camera at the top of the screen and of Obsidian’s buttons at the bottom. Automatic measures both. By hand, you give how tall each band is from the screen’s edge, and a view moves only as far as it lies under one. Hand-set values apply in portrait, on this device only.',
    'settings.mobileInsets.auto': 'Automatic',
    'settings.mobileInsets.manual': 'By hand',
    'settings.mobileInsetTop': 'Top band (camera)',
    'settings.mobileInsetBottom': 'Bottom band (buttons)',
    'settings.mobileInsets.now': 'Now',
    'settings.mobileInsets.applied': 'top {top} px · bottom {bottom} px',
    'settings.mobileInsets.measured':
        'Measured: the system keeps {top} px at the top and {bottom} px at the bottom; Obsidian’s buttons take {navbar} px.',
    ...
    'debug.code.blocks': 'Blocks',
    'debug.code.styled': 'Languages with an icon · {count}',
    'debug.code.plain': 'Known without an icon · {count}',
    'debug.copy': 'Copy',
    'debug.copied': 'Copied',
    'debug.filter': 'Filter…',
    'debug.refresh': 'Refresh',
    'debug.empty': 'Nothing here.',

    'debug.gallery.buttons': 'Buttons',
    'debug.gallery.toggles': 'Checkboxes and tiles',
    'debug.gallery.choice': 'Choice',
    'debug.gallery.numeric': 'Numbers',
    'debug.gallery.text': 'Text fields',
    'debug.gallery.rows': 'Setting rows',
    'debug.gallery.feedback': 'Hints and empty states',
    'debug.gallery.menu': 'Menu rows',
    'debug.gallery.badges': 'Badges, bars and cards',
    'debug.gallery.rich': 'Rating, charts, tabs, modal',
    ...
    'debug.strings.resolved': 'Rendered',
    'debug.strings.fromZenith': 'zenith',
    'debug.strings.core': 'Zenith dictionary',
    'debug.strings.active': 'Active locale',
    'debug.strings.keys.one': '{count} key',
    'debug.strings.keys.other': '{count} keys',
    'debug.strings.contributed': 'Contributed chunks',
    ...
    // ── Content types ───────────────────────────────
    'ctypes.hint': 'Types drive the library tabs and which fields each item shows.',
    ...
    'update.available': 'Zenith {version} is out',
    'update.open': 'Update',
    ...
    'content.form.coverPick': 'From vault',
    ...
    'content.import.coversNote':
        'Covers and synopses aren’t part of these exports, and nothing is looked up online. Add a cover to an item whenever you like.',
    ...
    'journal.widget.habitsAria': 'Trackers over the last {days} days',
    'journal.widget.todayOpen': 'today, not marked yet',
    ...
    'sync.progress.stored': 'Taken up on the server',
    ...
    'sync.quick.willDelete': '{count} to delete',
    'sync.quick.noDeletions': 'Nothing would be deleted.',
    'sync.quick.showAll': 'Show all {count}',
    'sync.quick.confirm': 'Confirm',
    'sync.quick.running': 'Syncing…',
    'sync.quick.retry': 'Try again',
    'sync.quick.setUp': 'Connect a server',
    'sync.quick.sent': 'Sent',
    'sync.quick.received': 'Received',
    'sync.quick.deleted': 'Deleted',
    'sync.quick.conflicts': 'Conflicts',
    'sync.quick.stored': 'On the server',
    'sync.quick.auto': 'Automatically',
    'sync.quick.auto.desc': 'At startup, every {minutes} min and after you edit.',
    'sync.quick.devices': 'Devices',
    'sync.quick.devices.none': 'Only this one so far.',
    'sync.quick.more': 'More',
    'sync.quick.preview': 'What would change',
    'sync.quick.preview.desc': 'Compare with the server first, then decide.',
    'sync.quick.settings': 'Sync settings',
    'sync.quick.apply': 'Sync',
    'sync.quick.review.preview': 'What would change',
    'sync.quick.state.off': 'No server connected',
    'sync.quick.state.off.sub': 'Dropbox, OneDrive, S3 or WebDAV, in the sync settings.',
    'sync.quick.state.busy': 'Syncing',
    'sync.quick.state.comparing': 'Comparing with the server…',
    'sync.quick.state.error': 'Sync did not finish',
    'sync.quick.state.partial': 'Some files did not move',
    'sync.quick.state.partial.sub': '{count} will be tried again on the next run.',
    'sync.quick.state.never': 'Not synced yet',
    'sync.quick.state.ok': 'In sync',
    'sync.quick.review.first_run_requires_review': 'First run with this server',
    'sync.quick.review.too_many_changes': 'More deletions than allowed',
    'sync.quick.review.forced_overwrite': 'Forced overwrite',
    'sync.bar.synced': 'Vault synced {when}',
    'sync.bar.checking': 'Checking for changes…',
    'sync.bar.notYet': 'Not synced yet this session',
    'sync.bar.held': 'Needs review',
    'sync.bar.error': 'Error',
    'sync.bar.failed': 'Failed: {count}',
    'sync.bar.failedTip': 'Some files did not sync. First: {key} — {error}',
    'sync.bar.offline': 'Offline — sync will resume when the connection is back',
    'sync.settings.oauthFolder.hint': 'account root',
    'sync.settings.localRoot.hint': 'the whole vault',
    'sync.settings.s3Prefix.hint': 'the whole bucket',
    ...
    // Sync — file engine UI
    'sync.files.title': 'Connection status',
...
const RU: Dict = {
    ...
    'settings.section.attention': 'Требует внимания',
    ...
    'settings.mobileInsets': 'Края экрана',
    'settings.mobileInsets.desc':
        'Виды не заезжают под камеру вверху экрана и под кнопки Obsidian внизу. «Автоматически» измеряет обе полосы. «Вручную» — вы задаёте высоту каждой полосы от края экрана, и вид отступает ровно настолько, насколько под неё заходит. Ручные значения действуют в портретном режиме и только на этом устройстве.',
    'settings.mobileInsets.auto': 'Автоматически',
    'settings.mobileInsets.manual': 'Вручную',
    'settings.mobileInsetTop': 'Полоса сверху (камера)',
    'settings.mobileInsetBottom': 'Полоса снизу (кнопки)',
    'settings.mobileInsets.now': 'Сейчас',
    'settings.mobileInsets.applied': 'сверху {top} px · снизу {bottom} px',
    'settings.mobileInsets.measured':
        'Измерено: система держит {top} px сверху и {bottom} px снизу, кнопки Obsidian занимают {navbar} px.',
    ...
    // ── Инструменты отладки ─────────────────────────
    'settings.about.debug': 'Инструменты отладки',
    ...
    'debug.code.blocks': 'Блоки',
    'debug.code.styled': 'Языки с иконкой · {count}',
    'debug.code.plain': 'Известные без иконки · {count}',
    ...
    'debug.gallery.buttons': 'Кнопки',
    'debug.gallery.toggles': 'Чекбоксы и плитки',
    'debug.gallery.choice': 'Выбор',
    'debug.gallery.numeric': 'Числа',
    'debug.gallery.text': 'Текстовые поля',
    'debug.gallery.rows': 'Строки настроек',
    'debug.gallery.feedback': 'Подсказки и пустые состояния',
    'debug.gallery.menu': 'Строки меню',
    'debug.gallery.badges': 'Бейджи, полосы и карточки',
    'debug.gallery.rich': 'Оценка, диаграммы, вкладки, модалка',
    ...
    'debug.strings.resolved': 'Отрисуется',
    'debug.strings.fromZenith': 'zenith',
    'debug.strings.core': 'Словарь Zenith',
    'debug.strings.active': 'Текущая локаль',
    'debug.strings.keys.one': '{count} ключ',
    'debug.strings.keys.few': '{count} ключа',
    'debug.strings.keys.many': '{count} ключей',
    'debug.strings.contributed': 'Чанки от модулей',
    ...
    // ── Типы контента ───────────────────────────────
    'ctypes.hint': 'Типы задают вкладки библиотеки и набор полей у элементов.',
    ...
    'update.available': 'Вышел Zenith {version}',
    ...
    'content.form.coverPick': 'Из хранилища',
    ...
    'content.import.coversNote':
        'Обложек и описаний в этих выгрузках нет, и в сети ничего не ищется. Обложку можно добавить элементу в любой момент.',
    ...
    'journal.widget.habitsAria': 'Отметки за последние {days} дней',
    'journal.widget.todayOpen': 'сегодня, ещё не отмечено',
    ...
    'sync.result.received.one': 'Получена {count} настройка с других устройств.',
    'sync.result.received.few': 'Получено {count} настройки с других устройств.',
    'sync.result.received.many': 'Получено {count} настроек с других устройств.',
    'sync.syncNow': 'Синхронизировать настройки',
    ...
    'sync.progress.stored': 'Занято в хранилище',
    ...
    'sync.quick.willDelete': 'удалить: {count}',
    'sync.quick.noDeletions': 'Ничего не будет удалено.',
    'sync.quick.showAll': 'Показать все {count}',
    'sync.quick.confirm': 'Подтвердить',
    'sync.quick.running': 'Синхронизация…',
    'sync.quick.retry': 'Повторить',
    'sync.quick.setUp': 'Подключить сервер',
    'sync.quick.sent': 'Отправлено',
    'sync.quick.received': 'Получено',
    'sync.quick.deleted': 'Удалено',
    'sync.quick.conflicts': 'Конфликты',
    'sync.quick.stored': 'На сервере',
    'sync.quick.auto': 'Автоматически',
    'sync.quick.auto.desc': 'При запуске, каждые {minutes} мин и после правок.',
    'sync.quick.devices': 'Устройства',
    'sync.quick.devices.none': 'Пока только это.',
    'sync.quick.more': 'Ещё',
    'sync.quick.preview': 'Что изменится',
    'sync.quick.preview.desc': 'Сначала сравнить с сервером, потом решить.',
    'sync.quick.settings': 'Настройки синхронизации',
    'sync.quick.apply': 'Синхронизировать',
    'sync.quick.review.preview': 'Что изменится',
    'sync.quick.state.off': 'Сервер не подключён',
    'sync.quick.state.off.sub': 'Dropbox, OneDrive, S3 или WebDAV — в настройках синхронизации.',
    'sync.quick.state.busy': 'Синхронизация',
    'sync.quick.state.comparing': 'Сравниваю с сервером…',
    'sync.quick.state.error': 'Синхронизация не завершилась',
    'sync.quick.state.partial': 'Часть файлов не перенеслась',
    'sync.quick.state.partial.sub': '{count} — попробую снова при следующем запуске.',
    'sync.quick.state.never': 'Ещё не синхронизировалось',
    'sync.quick.state.ok': 'Всё синхронизировано',
    'sync.quick.review.first_run_requires_review': 'Первый прогон с этим сервером',
    'sync.quick.review.too_many_changes': 'Удалений больше, чем разрешено',
    'sync.quick.review.forced_overwrite': 'Принудительная перезапись',
    'sync.bar.synced': 'Хранилище синхронизировано {when}',
    'sync.bar.checking': 'Проверка изменений…',
    'sync.bar.notYet': 'В этом сеансе ещё не синхронизировалось',
    'sync.bar.held': 'Ждёт проверки',
    'sync.bar.error': 'Ошибка',
    'sync.bar.failed': 'Не удалось: {count}',
    'sync.bar.failedTip': 'Часть файлов не синхронизировалась. Первый: {key} — {error}',
    'sync.bar.offline': 'Нет сети — синхронизация продолжится, когда связь вернётся',
    'sync.settings.oauthFolder.hint': 'корень аккаунта',
    'sync.settings.localRoot.hint': 'весь волт',
    'sync.settings.s3Prefix.hint': 'весь бакет',
