    ...
    groups: [
        ...
        },
        {
            ...
            fields: [
                ...
                { type: 'feature', key: 'prayer.iftarSuhoor' },
                {
                    type: 'number',
                    key: 'prayerImsakOffset',
                    labelKey: 'settings.prayerImsak',
                    descKey: 'settings.prayerImsak.desc',
                    default: 0,
                    min: 0,
                    max: 30,
                    step: 1,
                    unitKey: 'settings.minutesUnit',
                    showIf: whenFeature('prayer.iftarSuhoor'),
                },
            ],
        },
        {
