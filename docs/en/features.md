...
| Tasks | Capture into the daily note, natural input, capture from links (off by default), subtasks, attachments, timer, drag and drop, group by date, group by note, statistics, activity heatmap, widget |
